...
const Footer = () => (
  <footer className={s.footer}>
    <div className={s.socialIconsLeft}>
      <a href="https://t.me/ethanhjk" target="_blank" rel="noopener noreferrer">
    ...
    <div className={s.socialIconsRight}>
      <a href="https://instagram.com/ethanhjk" target="_blank" rel="noopener noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={s.icon}>
